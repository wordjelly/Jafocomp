...
class Logs::Event
	...
	attribute :information, Array[Logs::Information], mapping: {type: 'nested', properties: Logs::Information.index_properties}
	...
	def self.index_properties
		{
			...
			:information => {
				:type => 'nested',
				:properties => Logs::Information.index_properties
			}
		}
	end
